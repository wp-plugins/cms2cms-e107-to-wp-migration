=== CMS2CMS: e107 to WordPress Migration   ===
...
= Following content can be moved: =
* Pages
* Posts
* Categories
* Content images
...
= Migration features: =
* categories and content relationships are preserved
* web based, no additional download
* Demo migration available
* takes on average 15 minutes

= Video =
[youtube https://www.youtube.com/watch?v=cxdSAtJOauQ]
...
1. Go to Admin -> Plugins, find “e107  to WordPress Migration” and click Activate
